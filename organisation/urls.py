...
urlpatterns = [
    ...
    path('<int:organisation_id>/', views.organisation_detail, name='organisation_detail'),
    path('add/', views.add_organisation, name='add_organisation'),
    path('edit/<int:organisation_id>/', views.edit_organisation, name='edit_organisation'),
